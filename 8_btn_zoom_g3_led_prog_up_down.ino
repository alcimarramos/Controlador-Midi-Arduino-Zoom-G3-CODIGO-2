 ...
 * 8 pedais para patches 2 para bank UP e Down.
 * O 5º pedal de cima, e 5º pedal de baixo sobem e descem os bancos.
...
#define pino6 6   /*  Bank Down */
#define pino7 A0  /*  pedal patch5 */
#define pino8 A1  /*  pedal patch6 */
#define pino9 A2  /*  pedal patch7 */
#define pino10 A3 /*  pedal patch8 */
#define pino11 A4 /*  Bank Up */
...
//////////////////// PEDAL 6 ////////////////////
  if ( pedal5 == LOW ) { /*----------------------- Se o pedal 5 for pressionado */
      SendMIDI(patchA5 + (bank * 10)); /*--------- Envia o patch A5 e sobe, ou desce, 10 presets cada vez que o pedal benco é acionado */
...
//////////////////// PEDAL 7 ////////////////////
  if ( pedal6 == LOW ) { /*----------------------- Se o pedal 6 for pressionado */
      SendMIDI(patchA6 + (bank * 10)); /*--------- Envia o patch A6 e sobe, ou desce, 10 presets cada vez que o pedal benco é acionado */
...
//////////////////// PEDAL 8 ////////////////////
  if ( pedal7 == LOW ) { /*----------------------- Se o pedal 7 for pressionado */
      SendMIDI(patchA7 + (bank * 10)); /*--------- Envia o patch A7 e sobe, ou desce, 10 presets cada vez que o pedal benco é acionado */
...
//////////////////// PEDAL 9 ////////////////////
  if ( pedal8 == LOW ) { /*----------------------- Se o pedal 8 for pressionado */
      SendMIDI(patchA8 + (bank * 10)); /*--------- Envia o patch A8 e sobe, ou desce, 10 presets cada vez que o pedal benco é acionado */
...
////////////// PEDAL 10 - BANK UP ///////////////
  ...
  if ( bank_Up == LOW ) { /* Se o pedal 10 for pressionado */
      bankUp(); /*---------- Sobe o patch atual em 10 */
      led6on_();
      ledsoff();
      led6on_();
      ledsoff();
...
////////////// PEDAL 5 - BANK DOWN //////////////
  ...
  if ( bank_Down == LOW ) { /* Se o pedal 10 for pressionado */
      bankDown(); /*-------- Desce o patch atual em 10 */
      led5on_();
      ledsoff();
      led5on_();
      ledsoff();
